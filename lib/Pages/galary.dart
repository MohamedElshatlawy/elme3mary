...
import 'package:elme3mary/Pages/viewimage.dart';
...
class Galary extends StatefulWidget {
  ...
  final String title;
  Galary(this.exampleID, this.title);
  _BirdState createState() => new _BirdState();
}

class _BirdState extends State<Galary> {
  //===== Function  Poste ========================================
  void Function_Poste() {
  ...
  void getAllSubjects() {
    ...
    var url = "http://e3mar.vision.com.sa/API/GetExemplarIdSection.php?IDFormsSection="+widget.exampleID;
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: new Text("قائمة نماذج " + widget.title),
                    ),
                    Flexible(
